...
2	Blockly	Programmtic Logic Puzzle Game	10
3	Melon shopping	Shopping cart for melons	40
4	Pet Finder	Finding Pets	25
5	Food Finder	Finding good restaurants	10
\.
...
COPY students (first_name, last_name, student_github) FROM stdin;
Jane	Hacker	jhacks
...
ALTER TABLE ONLY students
    ADD CONSTRAINT students_pkey PRIMARY KEY (student_github);
